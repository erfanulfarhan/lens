...
export function OsIcon({ os, size = 22 }) {
    ...
    if (os === 'mac') {
        return (_jsxs("svg", { ...common, children: [_jsx("path", { d: "M16.3 12.6c0-2 1.6-3 1.7-3.05-.9-1.35-2.35-1.5-2.85-1.53-1.3-.1-2.4.72-3.02.72-.63 0-1.62-.7-2.66-.68-1.37.02-2.63.8-3.33 2.03-1.42 2.47-.36 6.13 1.02 8.14.68.98 1.49 2.03 2.55 1.99 1.02-.04 1.41-.66 2.65-.66 1.23 0 1.58.66 2.66.64 1.1-.02 1.8-1 2.47-1.98.78-1.13 1.1-2.22 1.12-2.28-.02-.01-2.15-.83-2.17-3.3Z", stroke: "currentColor", strokeWidth: "1.6", strokeLinejoin: "round" }), _jsx("path", { d: "M14.4 6.3c.54-.66.9-1.57.8-2.48-.78.03-1.73.52-2.29 1.18-.5.58-.93 1.51-.81 2.4.87.07 1.76-.44 2.3-1.1Z", stroke: "currentColor", strokeWidth: "1.6", strokeLinejoin: "round" })] }));
    }
    if (os === 'windows') {

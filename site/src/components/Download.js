...
export function Download({ compact = false }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-4", children: [_jsx("div", { className: "grid grid-cols-2 gap-2.5 sm:grid-cols-3", children: shown.map((b) => (_jsxs("a", { href: b.url, className: "pressable lift group flex min-h-[58px] items-center gap-3 rounded-xl border border-[var(--line)] px-4 py-3 transition-colors duration-150 hover:border-[var(--brass-dim)]", style: { background: 'var(--panel)' }, children: [_jsx("span", { className: "shrink-0 transition-colors duration-150", style: { color: 'var(--brass)' }, children: _jsx(OsIcon, { os: b.icon, size: 20 }) }), _jsxs("span", { className: "flex min-w-0 flex-col leading-tight", children: [_jsx("span", { className: "truncate text-[13.5px] font-semibold text-[var(--paper)]", children: b.label }), _jsxs("span", { className: "truncate text-[11.5px] text-[var(--faint)]", children: [b.detail, b.sizeMb ? ` · ${b.sizeMb}MB` : ''] })] })] }, b.url))) }), !compact && (_jsxs("p", { className: "text-[13px] leading-relaxed text-[var(--faint)]", children: ["Free, no account.", ' ', _jsx("a", { href: FALLBACK, className: "underline decoration-[var(--line)] hover:text-[var(--paper)]", children: "All builds and checksums" }), ". Not code-signed yet, so your machine will ask once."] }))] }));
}
